<script lang="ts">
	...
	let { class: className, title = 'Frequently Asked Questions', description = 'Get answers to your questions.', items = defaultFaqs, eyebrow = 'FAQ Section' }: Props = $props();
</script>
...
<section class={cn('w-full bg-background py-16 px-4 sm:px-6 lg:px-8', className)}>
	...
	<div class="mt-10 mx-auto max-w-2xl flex flex-col gap-6">
