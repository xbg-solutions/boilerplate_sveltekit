<!--
  CalendarBlock17.svelte
  Single month calendar with a combined time-range input (start–end) below.
-->
<script lang="ts">
...
<div class={cn('inline-flex flex-col rounded-md border p-4', className)}>
  ...
  <!-- Combined time range row -->
  <div class="mt-4 flex items-center gap-2 rounded-md border px-3 py-2">
