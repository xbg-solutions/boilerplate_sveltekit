<script lang="ts">
	...
	let {
		...
		title,
		description,
		testimonials = [defaultTestimonial, defaultTestimonial, defaultTestimonial]
	}: Props = $props();
				...
				<div class="rounded-lg border bg-background p-6">
					...
					<div class="border-t mt-4 pt-4">
						<div class="flex items-center gap-3">
							...
							{:else}
								<div
									class="h-8 w-8 rounded-full bg-muted overflow-hidden flex items-center justify-center text-muted-foreground text-xs font-semibold"
								>
