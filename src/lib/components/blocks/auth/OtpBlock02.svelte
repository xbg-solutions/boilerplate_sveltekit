<!--
  OtpBlock02.svelte
  OTP verification with phone number display instead of email.
-->
<script lang="ts">
    ...
    <CardContent>
      <form on:submit|preventDefault={handleSubmit} class="space-y-4">
        <div class="space-y-2">
          ...
          <p class="text-xs text-muted-foreground text-center">Enter the 6-digit code sent to your phone.</p>
        </div>
