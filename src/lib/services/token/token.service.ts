...
import { getFirebaseAuth, safeGetCurrentUser, subscribeToAuthChanges } from '../../utils/firebase';
import { 
  decodeToken, 
  extractClaims, 
  isTokenExpired, 
...
import { rbacUtil } from '../../utils/rbac';
import { tokenStore } from '../../stores/token.store';
import { secureStorage } from '../../utils/secure-storage';
import { AppError, handleError, normalizeError, withErrorHandling } from '../../utils/error-handler';
import { AUTH_NAMESPACE, AUTH_TOKEN_TTL, EMAIL_FOR_SIGN_IN_KEY } from '../../constants/secure-storage.constants';
import type { DecodedToken, TokenRefreshResult, TokenRole } from '../../types/token.types';
