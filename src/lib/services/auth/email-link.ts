...
import { getFirebaseAuth, getFirebaseState, processFirebaseError } from '../../utils/firebase';
import { secureStorage } from '../../utils/secure-storage';
import { loggerService } from '../logging/logging.service';
import { publish } from '../events';
import { AppError, handleError, normalizeError, withErrorHandling } from '../../utils/error-handler';
import { AUTH_EVENTS, AUTH_CONFIG, CREATE_AUTH_USER_ON_FIRST_SIGNIN } from '../../constants/auth.constants';
import { AUTH_NAMESPACE, EMAIL_FOR_SIGN_IN_KEY } from '../../constants/secure-storage.constants';
import type { EmailLinkOptions, EmailLinkVerifyOptions, AuthResult } from '../../types/auth.types';
