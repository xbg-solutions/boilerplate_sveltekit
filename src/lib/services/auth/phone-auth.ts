...
import {
  ...
  import { getFirebaseAuth, processFirebaseError } from '../../utils/firebase';
  import { loggerService } from '../logging/logging.service';
  import { publish } from '../events';
  import { AppError, normalizeError, withErrorHandling } from '../../utils/error-handler';
  import { AUTH_EVENTS, CREATE_AUTH_USER_ON_FIRST_SIGNIN } from '../../constants/auth.constants';
  import type { PhoneAuthOptions, PhoneCodeVerifyOptions, AuthResult } from '../../types/auth.types';
