...
import { stateManagerStore, type StateManagerState } from '@xbg.solutions/bpsk-utils-state-manager';
import { PersistenceStrategy } from '@xbg.solutions/bpsk-utils-state-manager';
